    ...
    <div class="page-content bg-white">
        ...
        <div class="rev-slider">
			<div id="rev_slider_486_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery36" data-source="gallery" style={{ margin:"0 px auto", backgroundColor:"#ffffff",padding:"0px",marginTop:"0 px",marginBottom:"0 px"}}>
				...
				<div id="rev_slider_486_1" style={{display:"block"}}  data-version="5.3.0.2">
					<ul>
						...
						<img src={slider1} alt="" 
							...
							<div class="tp-caption tp-shape tp-shapewrapper " 
								...
								style={{zIndex: "5",backgroundColor:"rgba(2, 0, 11, 0.80)",borderColor:"rgba(0, 0, 0, 0)",borderWidth:"0px"}}> </div>	
							...
							<div class="tp-caption Newspaper-Button rev-btn " 
								...
								style={{zIndex: "8", whiteSpace: "nowrap", outline:"none",boxBhadow:"none",boxSizing:"border-box",MozBoxSizing:"border-box",WebkitBoxSizing:"border-box",cursor:"pointer", backgroundColor:"var(--primary) !important", border:"0", borderRadius:"30px", marginRight:"5px"}}>READ MORE </div>
							<div class="tp-caption Newspaper-Button rev-btn" 
								...
								data-paddingbottom="[12,12,12,12]"
								data-paddingleft="[30,35,35,15]"
								style={{zIndex: "8", whiteSpace: "nowrap", outline:"none",boxShadow:"none",boxSizing:"border-box",MozBoxsizing:"border-box",WebkitBoxSizing:"border-box",cursor:"pointer", borderRadius:"30px"}}>CONTACT US</div>
						</li>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Button rev-btn " 
								...
								data-paddingbottom="[12,12,12,12]"
								data-paddingleft="[30,35,35,15]"
								style={{zIndex: "8", whiteSpace: "nowrap",outline:"none",boxShadow:"none",boxSizing:"border-box",MozBoxSizing:"border-box",WebkitBoxSizing:"borderBox",cursor:"pointer", backgroundColor:"var(--primary) !important", border:"0", borderRadius:"30px", marginRight:"5px"}}>READ MORE </div>
							<div class="tp-caption Newspaper-Button rev-btn" 
		...
		<div class="content-block">
			...
			<div class="section-area section-sp1 ovpr-dark bg-fix online-cours" style={{backgroundImage:bg1 }}>
				<div class="container">
					<div class="row">
			...
			<div class="section-area section-sp2 bg-fix ovbl-dark" style={{backgroundImage:"url(../../../assets/images/background/bg1.jpg)"}}>
                <div class="container">
					<div class="row">
